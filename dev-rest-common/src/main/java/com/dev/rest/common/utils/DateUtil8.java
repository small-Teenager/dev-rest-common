...
import com.dev.rest.common.exception.DateException;
...
public class DateUtil8 {
    ...
    private static String PATTERN_YYYY_MM_DD_HH_MM = "yyyy-MM-dd HH:mm";

    private static String PATTERN_YYYY_MM_DD_HH_MM_SS = "yyyy-MM-dd HH:mm:ss";

    private static String PATTERN_YYYYMMDDHHMM = "yyyyMMddHHmm";

    private static String PATTERN_YYMMDDHHMM = "yyMMddHHmm";

    private static String PATTERN_YYMMDDHH = "yyMMddHH";
    ...
    public static DateTimeFormatter YYYY_MM_DD_HH_MM = DateTimeFormatter.ofPattern(PATTERN_YYYY_MM_DD_HH_MM).withZone(ZONE);

    public static DateTimeFormatter YYYYMMDDHHMMSS = DateTimeFormatter.ofPattern(PATTERN_YYYYMMDDHHMMSS).withZone(ZONE);

    public static DateTimeFormatter YYYYMMDDHHMM = DateTimeFormatter.ofPattern(PATTERN_YYYYMMDDHHMM).withZone(ZONE);

    public static DateTimeFormatter YYMMDDHHMM = DateTimeFormatter.ofPattern(PATTERN_YYMMDDHHMM).withZone(ZONE);

    public static DateTimeFormatter YYMMDDHH = DateTimeFormatter.ofPattern(PATTERN_YYMMDDHH).withZone(ZONE);
    ...
    public static Date instantToDateConverter(Instant instant) {
        Optional.ofNullable(instant).orElseThrow(() -> new DateException("500", "instant can not be null"));
    ...
    public static Date localDateTimeToDateConverter(LocalDateTime localDateTime) {
        Optional.ofNullable(localDateTime).orElseThrow(() -> new DateException("500", "localDateTime can not be null"));
    ...
    public static Date localDateToDateConverter(LocalDate localDate) {
        Optional.ofNullable(localDate).orElseThrow(() -> new DateException("500", "localDate can not be null"));
    ...
    public static LocalDateTime localTimeToLocalDateTimeConverter(LocalTime localTime) {
        Optional.ofNullable(localTime).orElseThrow(() -> new DateException("500", "localTime can not be null"));
    ...
    public static Instant dateToInstantConverter(Date date) {
        Optional.ofNullable(date).orElseThrow(() -> new DateException("500", "date can not be null"));
    ...
    public static String format(Date date, DateTimeFormatter pattern) {
        Optional.ofNullable(date).orElseThrow(() -> new DateException("500", "date can not be null"));
        Optional.ofNullable(pattern).orElseThrow(() -> new DateException("500", "pattern can not be null"));
    ...
    public static Date formatDate(String text, DateTimeFormatter pattern) {
        if (StringUtils.isEmpty(text)) {
            throw new DateException("500", "can not format String :" + text);
        }
    ...
    public static LocalDateTime formatLocalDateTime(String text, DateTimeFormatter pattern) {
        ...
        try {
            ...
            throw new DateException("500", "format error :" + e.getMessage());
        }
    }
    ...
    public static LocalDate formatLocalDate(String text, DateTimeFormatter pattern) {
        ...
        try {
            ...
            throw new DateException("500", "why pattern does not have yyyymmdd? [" + pattern + "]");
        }
    }
    ...
    public static LocalTime formatLocalTime(String text, DateTimeFormatter pattern) {
        ...
        try {
            ...
            throw new DateException("500", "why pattern does not have hhmmdd? [" + pattern + "]");
        }
    }
    ...
    public static long between(Date source, Date target, TimeUnit timeUnit) {
        Optional.ofNullable(source).orElseThrow(() -> new DateException("500", "source can not be null"));
        Optional.ofNullable(target).orElseThrow(() -> new DateException("500", "target can not be null"));
        Optional.ofNullable(timeUnit).orElseThrow(() -> new DateException("500", "timeUnit can not be null"));
    ...
    public static long between(LocalDate source, LocalDate target, TimeUnit timeUnit) {
        ...
        if (TimeUnit.DAYS != timeUnit) {
            throw new DateException("500", "LocalDate can not get between with :" + timeUnit.name());
        }
    ...
    private static long doBetween(LocalDateTime source, LocalDateTime target, TimeUnit timeUnit) {
        ...
        switch (timeUnit) {
            ...
            case MICROSECONDS:
                return duration.toMillis() * 1000;
            default:
                throw new DateException("500", "unknown timeUnit:" + timeUnit.name());
        }
    }
    ...
    public static Date plus(Date source, long amount, TimeUnit timeUnit) {
        Optional.ofNullable(source).orElseThrow(() -> new DateException("500", "source can not be null"));
        Optional.ofNullable(amount).orElseThrow(() -> new DateException("500", "amount can not be null"));
        Optional.ofNullable(timeUnit).orElseThrow(() -> new DateException("500", "timeUnit can not be null"));
    ...
    public static LocalDate plus(LocalDate source, long amount, TimeUnit timeUnit) {
        ...
        Optional.ofNullable(timeUnit).orElseThrow(() -> new DateException("500", "timeUnit can not be null"));
        if (TimeUnit.DAYS != timeUnit) {
            throw new DateException("500", "LocalDate can not plus with :" + timeUnit.name());
        }
    ...
    public static <T> T plusNow(long amount, TimeUnit timeUnit, Class<T> tClass) {
        Optional.ofNullable(amount).orElseThrow(() -> new DateException("500", "amount can not be null"));
        Optional.ofNullable(timeUnit).orElseThrow(() -> new DateException("500", "timeUnit can not be null"));
        Optional.ofNullable(tClass).orElseThrow(() -> new DateException("500", "tClass can not be null"));
        if (tClass.getName().equals(Date.class.getName())) {
            ...
            throw new DateException("500", "can not plus now with class:" + tClass.getName());
        }
    }
    ...
    public static LocalDate minus(LocalDate source, long amount, TimeUnit timeUnit) {
        ...
        Optional.ofNullable(timeUnit).orElseThrow(() -> new DateException("500", "timeUnit can not be null"));
        if (TimeUnit.DAYS != timeUnit) {
            throw new DateException("500", "LocalDate can not minus with :" + timeUnit.name());
        }
    ...
    public static <T> T minusNow(long amount, TimeUnit timeUnit, Class<T> tClass) {
        ...
        if (tClass.getName().equals(Date.class.getName())) {
            ...
            throw new DateException("500", "can not minus now with class:" + tClass.getName());
        }
    }
    ...
    /**
     * @Description  获得某天最小时间 2020-12-08 00:00:00
     * @param date 时间
     * @return LocalDateTime
     */
    ...
    /**
     * @Description  localDateTime转换时间戳
     * @param localDateTime
     * @return java.lang.Long
     */
    public static Long formatTimeMillis(LocalDateTime localDateTime){
     ...
     */
    public static LocalDateTime formatLocalDateTime(Long timeMillis){
        return LocalDateTime.ofEpochSecond(timeMillis, 0, ZoneOffset.ofHours(8));
    }
}
